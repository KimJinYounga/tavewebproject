...
<body>
    ...
    <div id="main" class="scroll-container">
        ...
        <!--section 2-->
		<section class="section2" style="background: rgba(185, 96, 12, 0.23);">
			<div style="top: 50%; padding-top: 15%; height: 30%;">

				<div style="display: inline; margin: 0 auto;">
					<div class="sec2-1">
						<p style="font-family: 'Archivo Black', sans-serif; margin: 0.5rem 0; vertical-align: middle;">
							HELLO <br>
							WE <br>
							ARE <br>
							TAVE
		...
		<!--section 3-->
		<section class="section3" style="background: rgba(185, 96, 12, 0.23);">
			<div style="top: 82%; padding: 0 13%; color:rgb(255, 245, 234);">

				<div style="display: inline-block; width: 42%; padding: 6% 1% 0 4%; vertical-align: middle;">
				...
				<div style="box-shadow: 0 0 2rem 0 rgba(122, 59, 0, 0.863); margin: 3% 4% 0 1%;
						width: 43%; border-radius: 30px; padding: 5px; border-color: rgb(255, 115, 0); float: right;">
		...
		<!--section 4-->
		<section class="section4" style="background: rgba(185, 96, 12, 0.23);">
			<div style="top: 83%; padding: 0 13%; color:rgb(255, 245, 234);">

				<div style="box-shadow: 0 0 2rem 0 rgba(122, 59, 0, 0.863); margin: 3% 1% 0 4%;
						width: 43%; border-radius: 30px; padding: 5px; border-color: rgb(255, 115, 0); float: left;">
					<img style="height: 100%; width: 100%; border-radius: 30px;"
		...
		<!--section 5-->
		<section class="section5" style="background: rgba(185, 96, 12, 0.23);">
			<div style="top: 65%; padding: 10% 10% 0 10%; color:rgb(255, 245, 234);">

				<div style="text-align: center;">
					<p class="sec5-1">CONFERENCE</p>

					<img src="${pageContext.request.contextPath}/assets/img/i-5.jpg"
						style="border-radius: 50%; width: 13%; margin: 2.5%; box-shadow: 0 0 1.8rem 0 rgba(190, 132, 78, 0.692);">
		...
		<!--section 6-->
		<section class="section6" style="background: rgba(185, 96, 12, 0.23);">
			<div style="top: 50%; padding: 10% 15%; color:rgb(255, 245, 234);">

				<table width="72%" style="margin: auto;">
					<tr>
						<td width="50%" style="padding: 1% 4%;">
							<p class="sec6-1" style="float: left; margin: 10%;">T</p>
							<span style="padding: 5%; margin: 2%;">
