...
<body style="background: rgba(185, 96, 12, 0.23);">
	...
	<div id="main" class="scroll-container">
		...
		<section class="section2">
			<div style="top: 50%; height: 100%;">
				...
				<div class="content" style="height: 100%; padding: 0px; top: 50%;">
					...
					<div class="container" style="top: 50%; display: inline; margin: 0 auto;">
						<div class="sec2-1">
		...
		<section class="section3">
			<div style="top: 50%; height: 100%;">
				...
				<div class="content" style="height: 100%; top: 50%; text-align: center; vertical-align: middle;">
					...
					<div style="top: 50%; width: 32%; display: inline-block;">
					...
					<div style="top: 44%; width: 30%; box-shadow: 0 0 2rem 0 rgba(122, 59, 0, 0.863); display: inline-block;
						border-radius: 30px; padding: 0.3rem; border-color: rgb(255, 115, 0); margin: 3%;">
		...
		<section class="section6">
			<div style="top: 70%; height: 100%;">

				<div class="content" style="height: 100%; top: 50%; vertical-align: middle;">
